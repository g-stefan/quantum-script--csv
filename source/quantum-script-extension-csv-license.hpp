...
#define QUANTUM_SCRIPT_EXTENSION_CSV_LICENSE_HPP
...
namespace Quantum {
	namespace Script {
		namespace Extension {
			namespace CSV {
				namespace License {
					QUANTUM_SCRIPT_EXTENSION_CSV_EXPORT const char *content();
					QUANTUM_SCRIPT_EXTENSION_CSV_EXPORT const char *shortContent();
				};
			};
		};
	};
