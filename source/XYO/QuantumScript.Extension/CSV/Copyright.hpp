...
namespace XYO::QuantumScript::Extension::CSV::Copyright {
	XYO_QUANTUMSCRIPT_EXTENSION_CSV_EXPORT std::string copyright();
	XYO_QUANTUMSCRIPT_EXTENSION_CSV_EXPORT std::string publisher();
	XYO_QUANTUMSCRIPT_EXTENSION_CSV_EXPORT std::string company();
	XYO_QUANTUMSCRIPT_EXTENSION_CSV_EXPORT std::string contact();
};
