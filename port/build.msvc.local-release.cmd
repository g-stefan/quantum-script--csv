...
echo -^> local-release quantum-script-extension-csv
...
call :cmdX xyo-cc quantum-script-extension-csv --archive-release-sha512 --version-file=source/quantum-script-extension-csv.version.ini
