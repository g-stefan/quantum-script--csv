...
#ifndef QUANTUM_SCRIPT_EXTENSION_CSV_HPP
	...
	namespace Script {
		namespace Extension {
			namespace CSV {
				...
				QUANTUM_SCRIPT_EXTENSION_CSV_EXPORT void initExecutive(Executive *executive, void *extensionId);
				QUANTUM_SCRIPT_EXTENSION_CSV_EXPORT void registerInternalExtension(Executive *executive);
